...
| | `translate.py` | `translate_mai.py` | `translate_mai2.py` |
|---|---|---|---|
| **엔진** | Azure Speech Translation SDK | MAI-Transcribe-1 (REST API 직접 호출) | MAI-Transcribe-1 (azure-ai-transcription SDK) |
...
### translate_mai.py — MAI-Transcribe-1 (REST API)
...
### translate_mai2.py — MAI-Transcribe-1 (azure-ai-transcription SDK)
...
python translate_mai2.py "https://www.youtube.com/watch?v=VIDEO_ID" --chunk 5

# 소스 언어 지정 (기본: en-US)
python translate_mai2.py "https://www.youtube.com/watch?v=VIDEO_ID" --source-locale ja-JP

# SRT 자막 파일 생성
python translate_mai2.py "https://www.youtube.com/watch?v=VIDEO_ID" --output output.srt
```
